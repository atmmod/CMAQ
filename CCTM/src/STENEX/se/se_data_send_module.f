...
! --------------------------------------------------------------------------
     ...
     &                       se_5d_data_send, 
     &                       se_1d_data_send_r8, 
     &                       se_2d_data_send_r8, se_2de_data_send_r8,
     &                       se_3d_data_send_r8, se_3de_data_send_r8,
     &                       se_4d_data_send_r8, se_4de_data_send_r8,
     &                       se_5d_data_send_r8      
          end interface
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        subroutine se_1d_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!       call mpi_isend (sarray, scount, mpi_real, send_to(dir_ind),
!    &                  tag, se_worker_comm, request, error)
        call mpi_send (sarray, scount, mpi_real8, send_to(dir_ind),
     &                  tag, se_worker_comm, error)

        deallocate (sarray)

        end subroutine se_1d_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
       ...
       subroutine se_2d_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_2d_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        subroutine se_2de_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_2de_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
       ...
       subroutine se_3d_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_3d_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
       ...
       subroutine se_3de_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_3de_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        subroutine se_4d_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_4d_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        subroutine se_4de_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_4de_data_send_r8
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        subroutine se_5d_data_send_r8 (data, sind, send_to, dir_ind, tag, request)
...
!    &                  tag, se_worker_comm, request, error)
     ...
     &                  tag, se_worker_comm, error)
        ...
        end subroutine se_5d_data_send_r8
