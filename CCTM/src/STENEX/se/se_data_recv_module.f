...
! --------------------------------------------------------------------------
     ...
     &                       se_5d_data_recv, 
     &                       se_1d_data_recv_r8, 
     &                       se_2d_data_recv_r8, se_2de_data_recv_r8,
     &                       se_3d_data_recv_r8, se_3de_data_recv_r8,
     &                       se_4d_data_recv_r8, se_4de_data_recv_r8,
     &                       se_5d_data_recv_r8     
          end interface
...
! -- unpack received data
        ...
        subroutine se_1d_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- receive data from corresponding processor
        ...
        call mpi_recv (rarray, rcount, mpi_real8, recv_from(dir_ind),
     &                 tag, se_worker_comm, status, error)
...
! -- unpack received data
        ...
        end subroutine se_1d_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_2d_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_2d_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_2de_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_2de_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_3d_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_3d_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_3de_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_3de_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_4d_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_4d_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_4de_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_4de_data_recv_r8
...
! -- unpack received data
        ...
        subroutine se_5d_data_recv_r8 (data, rind, recv_from, dir_ind, tag)
...
! -- unpack received data
        ...
        end subroutine se_5d_data_recv_r8
